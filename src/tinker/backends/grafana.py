...
class GrafanaBackend(ObservabilityBackend):
    ...
    def __init__(self, config: dict | None = None) -> None:
        cfg = config or {}
        self._loki_url = cfg.get("loki_url") or ""
        self._prom_url = cfg.get("prometheus_url") or ""
        self._tempo_url = cfg.get("tempo_url") or ""
        self._service_label: str = cfg.get("service_label") or "service"
        self._log_format: str = cfg.get("log_format") or "label"
